...
`#1` Kondo et al. 2025（全文PDF・Supplementary Information）、`#2` Ashwood et al. 2022（bioRxiv preprint全文）、`#3` Cuturela et al. 2024（bioRxiv preprint全文）、`#7` Cazettes et al. 2025（bioRxiv preprint全文）、`#8` Tlaie et al. 2025（出版版全文・Supplementary Information）は、原本PDFを [sources/](sources/) に保存しています。
