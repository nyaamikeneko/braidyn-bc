...
論文PDFを [sources/](sources/) に保存している6本（#1, #2, #3, #4, #7, #8）は個別ファイルがあり、要旨（原文PDFに基づく箇条書き）とモデル定義・メソッドの詳細はそちらに記載しています。ここでは書誌情報と要約のみを示します。PDF未保存の8本（#5, #6, #9, #10, #11, #12, #13, #14）は、この一覧が唯一の情報源です。
...
Hulsey, D., Zumwalt, K., Mazzucato, L., McCormick, D. A., Jaramillo, S. — Cell Reports 43(2), 113709 (2024). DOI: [10.1016/j.celrep.2024.113709](https://doi.org/10.1016/j.celrep.2024.113709)
